...
using NG.Mediator;
using NG.Mediator.Entities;
using NG.Mediator.NotificationPublishers;
using NG.Mediator.Pipeline;
using NG.Mediator.Registration;
...
public class MediatorServiceConfiguration
{
    ...
    /// <summary>
    /// Configure the Maximum Amount of Generic RequestHandler Types NG.Mediator will try to register.  To Disable this constraint, set the value to 0.
    /// </summary>
    ...
    /// <summary>
    /// Flag that controlls whether NG.Mediator will attempt to register handlers that containg generic type parameters.
    /// </summary>
