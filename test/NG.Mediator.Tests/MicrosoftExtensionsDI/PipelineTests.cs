...
namespace NG.Mediator.Extensions.Microsoft.DependencyInjection.Tests;
...
public class PipelineTests
{
    ...
    public async Task Should_register_correctly()
    {
        ...
        services.AddSingleton(new NG.Mediator.Tests.PipelineTests.Logger());
        services.AddSingleton(new NG.Mediator.Tests.StreamPipelineTests.Logger());
        services.AddSingleton(new NG.Mediator.Tests.SendTests.Dependency());
