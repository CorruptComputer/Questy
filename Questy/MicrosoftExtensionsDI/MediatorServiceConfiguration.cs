...
public class MediatorServiceConfiguration
{
    ...
    /// <summary>
    /// Configure the Maximum Amount of Generic RequestHandler Types Questy will try to register.  To Disable this constraint, set the value to 0.
    /// </summary>
    ...
    /// <summary>
    /// Flag that controlls whether Questy will attempt to register handlers that containg generic type parameters.
    /// </summary>
